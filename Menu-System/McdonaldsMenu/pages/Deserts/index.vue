...
if (extraAdded.length > 0 ){
      const item = {
        ...
        itemName: "حلويات",
        isDeserts:true,
        itemNameEnglish: "Deserts",
        imageUri:require('assets/images/WildBerryDonut.png'),
        itemDescription: "Deserts",
        itemDescriptionEnglish: "Deserts",
...
debugger
    ...
    GetDeserts() {
      axios.get(`${this.$axios.defaults.baseURL}/api/MenuSystem/GetDeserts?tenantID=${this.tenantID}&menuType=${this.menuType}`, {
        headers: {
          'Content-Type': 'application/json',
          'Access-Control-Allow-Origin': '*'
        }
