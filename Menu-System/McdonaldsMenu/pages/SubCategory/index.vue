...
<template>
    ...
    <nav
            ...
            <div class="nav-item "
                :class="{'active':Number(subCategoryIdSelected)===category.id}" >
      ...
      <div class="bodycontainer">
          ...
          <div class="row">
              ...
              <div id="scrolling_div" class="col-12 col-sm-12 col-md-12 p-2 pb-0"
              v-for="(subcategory) of SubCategoryList"
                      :key="subcategory.id"
              ...
              <div class="row m-0">
                <div class="col-md-2 col-3">
                  <img :src="subcategory.bgImag"  class="img-fluid" alt="Photo of sunset">
                </div>
                <div class="col-md-9 col-8 d-flex align-items-center">
                <div>
                 <button type="button" class="btn buttonTitle">{{ getTranslationKey(subcategory.name, subcategory.nameEnglish) }}</button>
                 <div class="text-green">{{ $t('FROM') }} {{ $t('JOD') }} {{subcategory.price}}</div>
                 <p class="new-item" v-if="subcategory.isNew === true"><i class="fas fa-star fa-fw"></i> {{ $t('New') }}</p>
                </div>

                </div>
                <div class="col-md-1 col-1 d-flex align-items-center justify-content-between">
...
export default {
  ...
  beforeMount() {
    ...
    this.subCategoryIdSelected = this.$route.query.SubcategoryId ;
    this.getTenantInfo();
    this.GetMenu();
      debugger
...
this.CategoryList = JSON.parse(localStorage.getItem('menuItem'))
  ...
  methods: {
    ...
    goToCategory(category) {
         this.subCategoryIdSelected=category.id
...
//
     ...
     //this.subCategoryIdSelected=subCat.id;
