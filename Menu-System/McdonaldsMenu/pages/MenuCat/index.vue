  ...
  <div style="position: absolute; z-index: 99999999999999999999;">
    ...
    <b-sidebar id="sidebar-1" title="Menu" shadow style="background-color: #ffc423;">
      <div class="px-3 py-2">
                   ...
                   <div
                        v-for="(menuItem,menuItemIndex) of MenuList"
                        :key="menuItem.id"
                        :id="'menuItem'+menuItem.id" >
                              ...
                              <div  class="row" style=" padding: 2%;box-shadow: 0 2px 2px #d69c00;">         
                               ...
                               <div
                                   v-for="(Categorys,CategorysIndex) of menuItem.getCategorysModels"
                                   :key="Categorys.id"
                                    @click="menuItem.isInService ?goToCategory(menuItem,Categorys):''"                                   
    ...
    <div id="scrolling_div" class="CategoryItem">


      <div  class="catpointer d-flex flex-column category-items" style="  lang === 'ar' ?    direction: rtl; text-align: right;  : direction: ltr; text-align: left;">


        
        <nav
          v-dragscroll="true"
          class="navbar navbar-expand align-center px-0 dragscroll overflow-hidden " style=" font-weight: bold;font-size: 15px; white-space: nowrap ; background: #f4f4f4; border-radius: 25px;"
        >
          <div 
            v-for="(category,i) of CategoryList.getCategorysModels"
            :key="i"
          ...
          >
            ...
            {{ getTranslationKey(category.name, category.nameEnglish) }}
          </div>
        </nav>
...
<div class="container mt-2 mb-5">
  ...
  <div class="row MenuItem">
    ...
    v-for="(subCategory,subCategoryIndex) of SubCategoryList"
            :key="subCategory.id"
            :id="'subCategory'+subCategory.id"
           @click="goToSubCategoryItems(subCategory)">
      <div class="card card-block">
     
    <img :src="subCategory.bgImag" alt="Photo of sunset">
       <button type="button" class="btn btn-warning" style="width: 100%;">{{ getTranslationKey(subCategory.name, subCategory.nameEnglish) }}</button>
...
export default {
  ...
  beforeMount() {
    ...
    this.GetMenu();
      ...
      this.CategoryList = JSON.parse(localStorage.getItem('menuItem'))

      if(this.categoryId==null){
        this.goToCategory(this.CategoryList.getCategorysModels[0])
      }else{
        this.CategoryList.getCategorysModels.forEach(cat => {
