       ...
       <div> <img  :src="lang === 'ar' ?require('assets/images/MenuCategorylogoAr.png'):require('assets/images/MenuCategorylogo.jpg')" > </div>
        <div class="shopping-cart" @click="$store.state.item.cart.length>0 ?openCart():''">
          <span class="count">{{$store.state.item.cart.length}}
              ...
              <i class="fa fa-shopping-cart">Cart</i></button>
 </div>
          ...
          <div class="bodycontainer pt-0">
                    ...
                    <div class="row m-2">
                      ...
                      <div class="card card-details-img ">
                        <div class="text-center"><img class="bg-img" :src="this.subCategorySelected.bgImag"></div>
                               ...
                               >
                                   ...
                                   <div class="row m-0">
                                      ...
                                      <div class="col-5 col-md-6 d-flex align-items-center ">
                                        ...
                                        <div v-if="lang0 === 'ar'" class="title ARClass" style="word-wrap: break-word; font-size: 18px;"> {{ getTranslationKey(items.itemName, items.itemNameEnglish) }} </div>                         <div v-else  class="title  ENClass" style="font-weight: bold;word-wrap: break-word; font-size: 18px;"> {{ getTranslationKey(items.itemName, items.itemNameEnglish) }} </div>
