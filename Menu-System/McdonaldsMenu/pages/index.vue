...
<template>
    ...
    <div>
      ...
      <div class="cardmainmnue">
          ...
          <b-button style="z-index: 10000;" v-b-toggle.sidebar-1 class="btn-secondary-card"><i class="fas fa-align-justify"></i></b-button>
  ...
  methods: {
    ...
    filteredList(item) {
      ...
      GetMenu() {
                ...
                axios.get(`${this.$axios.defaults.baseURL}/api/MenuSystem/GetMenu?TenantID=${this.tenantID}&MenuType=${this.menuType}`, {
                      headers: {
