 ...
 <div class="d-flex justify-content-between  relative header-container">
      ...
      <div class="cardmainmnue">
          ...
          <div class="">
             ...
             <div v-for="(menuItem,menuItemIndex) of MenuList"
                            :key="menuItem.id"
...
if (extraAdded.length > 0 ){
      ...
      const item = {
        ...
        itemName: "الصوص",
        isCondiments:true,
        itemNameEnglish: "Condiments",
        //imageUri: "",
         imageUri:require('assets/images/wos_condiment.jpg'),
        itemDescription: "Condiments",
        itemDescriptionEnglish: "Condiments",
...
debugger
    ...
    GetCondiments() {
      axios.get(`${this.$axios.defaults.baseURL}/api/MenuSystem/GetCondiments?tenantID=${this.tenantID}&menuType=${this.menuType}`, {
        headers: {
          'Content-Type': 'application/json',
          'Access-Control-Allow-Origin': '*'
        }
        ...
        //this.item.itemName="Condiments"
       // this.item.itemNameEnglish="Condiments"
