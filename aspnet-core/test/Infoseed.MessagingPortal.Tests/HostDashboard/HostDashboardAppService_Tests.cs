...
using Infoseed.MessagingPortal.MultiTenancy.HostDashboard;
...
namespace Infoseed.MessagingPortal.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(MessagingPortalDbContext context, SubscriptionPayment subscriptionPayment)
        {
