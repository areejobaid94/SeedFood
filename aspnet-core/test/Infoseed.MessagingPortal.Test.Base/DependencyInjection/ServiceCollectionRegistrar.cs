...
namespace Infoseed.MessagingPortal.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<MessagingPortalDbContext>>()
            ...
            new MessagingPortalDbContext(builder.Options).Database.EnsureCreated();
        }
