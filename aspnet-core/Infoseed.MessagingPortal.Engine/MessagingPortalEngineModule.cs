...
namespace Infoseed.MessagingPortal.Engine
{
    ...
    public class MessagingPortalEngineModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MessagingPortalEngineModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MessagingPortalEngineModule).GetAssembly());
        }
