...
using Infoseed.MessagingPortal.Web.Models.Consent;

namespace Infoseed.MessagingPortal.Web.Host.Controllers
{
    public class ConsentController : MessagingPortalControllerBase
    {
