...
namespace Infoseed.MessagingPortal.Web.Controllers
{
    ...
    public class MenuController : MessagingPortalControllerBase
    {
        ...
        // GET: api/<CTownApiController>
       

        [Route("GetCatogeory")]
        [HttpGet]
        public List<CreateOrEditMenuCategoryDto> GetCatogeory(long menuID)
        {

            List<CreateOrEditMenuCategoryDto> categorysInItemModel = new List<CreateOrEditMenuCategoryDto>();
            categorysInItemModel = _IMenusAppService.GetCategorysByMenuID(menuID);
            return categorysInItemModel.OrderBy(x => x.Priority).ToList();
        }


        [Route("AddSubCatogeory")]
        [HttpPost]
        public long AddSubCatogeory(CreateOrEditMenuSubCategoryDto createOrEditMenuSubCategoryDto)
        {

            var id = _IMenusAppService.AddSubCatogeory(createOrEditMenuSubCategoryDto);
            return id;
        }

        [Route("UpdateSubCatogeory")]
        [HttpPost]
        public void UpdateSubCatogeory(CreateOrEditMenuSubCategoryDto createOrEditMenuSubCategoryDto)
        {
            _IMenusAppService.UpdateSubCatogeory(createOrEditMenuSubCategoryDto);

        }

        [Route("DeleteSubCatogeory")]
        [HttpPost]
        public bool DeleteSubCatogeory(long subCategoryID)
        {
           return _IMenusAppService.DeleteSubCatogeory(subCategoryID);
        ...
        {
           return _IItemsAppService.GetItemsByMenuID( menuID,  itemCategoryId,  itemSubCategoryId, pageNumber, pageSize);
        ...
        //                    var _filePath = "wwwroot\\UploadFile\\" + item.FileName;



        //                    var urlss = _obj.UploadFile(_filePath, "4408da24-aad7-4802-a1f1-46f5ad9e2074");
        ...
        //[Route("TestCtown")]
        //[HttpGet]
        //public string TestCtown(int FromItemCategoryId, int FromItemSubCategoryId, string FromNameCategoryE, bool isCreateSubCategory)
        //{
        ...
        //[HttpGet]
        //public string DeleteItemDoublicat(int copyeFromMenuType, int ItemSubCategoryId)
        //{
        ...
        //[HttpPost]
        //public async Task<string> CtownUploadExcelFileAsync([FromForm] UploadFileModel file, string ItemSubCategoryName, bool replece)
        //{
        //    int TenantId = 34;
        //    if (file == null || file.FormFile.Length == 0)
        //        return "NotFound";
                    ...
                    if (item.DateFrom == null)
                    {
                        using (SqlCommand command = connection.CreateCommand())
                        {
                            ...
                            command.CommandText = "INSERT INTO Items "
                                + " (ItemCategoryId ,ItemSubCategoryId ,ImageUri ,IsDeleted ,IsInService, ItemName, ItemNameEnglish ,Price,Priority,MenuId,Barcode,SKU,Size,Qty,MenuType,CreationTime,LanguageBotId,TenantId  ,Status_Code ) VALUES "
                                + " (@ItemCategoryId ,@ItemSubCategoryId ,@ImageUri ,@IsDeleted,@IsInService, @ItemName ,@ItemNameEnglish,@Price,@Priority ,@MenuId,@Barcode,@SKU,@Size,@Qty,@MenuType,@CreationTime,@LanguageBotId,@TenantId  ,@Status_Code ) ";
