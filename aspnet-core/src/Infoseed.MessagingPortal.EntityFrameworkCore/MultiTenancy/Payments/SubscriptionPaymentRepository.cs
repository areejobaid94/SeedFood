...
{
    public class SubscriptionPaymentRepository : MessagingPortalRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<MessagingPortalDbContext> dbContextProvider)
