...
using Infoseed.MessagingPortal.EntityFrameworkCore.Repositories;

namespace Infoseed.MessagingPortal.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : MessagingPortalRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<MessagingPortalDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
