...
using Infoseed.MessagingPortal.Migrations.Seed.Host;
...
namespace Infoseed.MessagingPortal.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : MessagingPortalAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<MessagingPortalDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{MessagingPortalConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{MessagingPortalConsts.ConnectionStringName}", constring);
        }
