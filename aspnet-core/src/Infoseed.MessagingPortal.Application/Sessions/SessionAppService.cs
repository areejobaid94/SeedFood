...
{
    public class SessionAppService : MessagingPortalAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = MessagingPortalConsts.Currency,
                    CurrencySign = MessagingPortalConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = MessagingPortalConsts.AllowTenantsToChangeEmailSettings,
