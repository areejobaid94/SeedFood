...
namespace Infoseed.MessagingPortal.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : MessagingPortalAppServiceBase, INotificationAppService
    {
        ...
        public async Task<GetNotificationsOutput> GetUserNotifications(GetUserNotificationsInput input)
        {
                ...
                userNotifications.Add(new UserNotification { 
                    ...
                    Id= not.Id,
                     Notification= new TenantNotification {
                         ...
                         CreationTime = not.Notification.CreationTime.AddHours(3),
                         Data = not.Notification.Data,
                            EntityId= not.Notification.EntityId,
                             TenantId= not.Notification.TenantId, 
                              EntityType= not.Notification.EntityType,
                               EntityTypeName= not.Notification.EntityTypeName,
                                Id= not.Notification.Id, 
                                 NotificationName= not.Notification.NotificationName,
                                  Severity= not.Notification.Severity
            ...
            return new GetNotificationsOutput(totalCount, unreadCount, userNotifications);
        }
