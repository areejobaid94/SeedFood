...
using Infoseed.MessagingPortal.Authorization.Users.Profile.Cache;
...
using Infoseed.MessagingPortal.Gdpr;
...
{
    [AbpAuthorize]
    public class ProfileAppService : MessagingPortalAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Infoseed.MessagingPortal",
