...
namespace Infoseed.MessagingPortal.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : MessagingPortalServiceBase, ITransientDependency
    {
