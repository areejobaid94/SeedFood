...
namespace Infoseed.MessagingPortal.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : MessagingPortalServiceBase, ITransientDependency
    {
