...
using Infoseed.MessagingPortal.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Infoseed.MessagingPortal.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : MessagingPortalAppServiceBase, IDashboardCustomizationAppService
    {
