...
using Infoseed.MessagingPortal.DemoUiComponents.Dto;

namespace Infoseed.MessagingPortal.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : MessagingPortalAppServiceBase, IDemoUiComponentsAppService
    {
