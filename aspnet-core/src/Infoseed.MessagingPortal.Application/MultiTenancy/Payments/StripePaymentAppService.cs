...
using Infoseed.MessagingPortal.MultiTenancy.Payments.Stripe;
...
{
    public class StripePaymentAppService : MessagingPortalAppServiceBase, IStripePaymentAppService
    {
