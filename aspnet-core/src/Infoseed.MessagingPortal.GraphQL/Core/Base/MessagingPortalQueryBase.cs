...
namespace Infoseed.MessagingPortal.Core.Base
{
    public abstract class MessagingPortalQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected MessagingPortalQueryBase(string fieldName,
