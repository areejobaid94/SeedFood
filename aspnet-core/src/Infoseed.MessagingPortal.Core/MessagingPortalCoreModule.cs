...
using Infoseed.MessagingPortal.Authorization.Ldap;
...
using Infoseed.MessagingPortal.DashboardCustomization.Definitions;
using Infoseed.MessagingPortal.Debugging;
using Infoseed.MessagingPortal.DynamicEntityProperties;
using Infoseed.MessagingPortal.Features;
using Infoseed.MessagingPortal.Friendships;
using Infoseed.MessagingPortal.Friendships.Cache;
using Infoseed.MessagingPortal.Localization;
using Infoseed.MessagingPortal.MultiTenancy;
using Infoseed.MessagingPortal.Net.Emailing;
using Infoseed.MessagingPortal.Notifications;
using Infoseed.MessagingPortal.WebHooks;

namespace Infoseed.MessagingPortal
{
    [DependsOn(
        typeof(MessagingPortalCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class MessagingPortalCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            MessagingPortalLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = MessagingPortalConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, MessagingPortalMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
           // Configuration.ReplaceService<IMailKitSmtpBuilder, DefaultMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            if (DebugHelper.IsDebug)
            {
               ...
               // Configuration.ReplaceService<IEmailSender, SmtpEmailSender>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<MessagingPortalSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MessagingPortalCoreModule).GetAssembly());
        }
