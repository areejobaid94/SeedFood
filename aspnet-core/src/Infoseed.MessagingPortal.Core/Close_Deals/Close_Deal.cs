...
{
    [Table("Close_Deals")]
    public class Close_Deal : Entity, IMayHaveTenant
    {
        ...
        public virtual string CustomerCommercialNameArabic { get; set; }



        public virtual DateTime ContrevelDate { get; set; }

        public virtual string FirstPay { get; set; }

        public virtual string SecondPay { get; set; }

        public virtual string AMClosed { get; set; }

        public virtual int? CloseDealStatusId { get; set; }

        [ForeignKey("CloseDealStatusId")]
        public CloseDealStatus CloseDealStatusFk { get; set; }
