...
{
    public class StripeGatewayManager : MessagingPortalServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "MessagingPortal";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + MessagingPortalConsts.Currency;
        }
