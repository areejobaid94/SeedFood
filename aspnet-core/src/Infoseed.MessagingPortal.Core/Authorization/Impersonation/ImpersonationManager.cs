...
namespace Infoseed.MessagingPortal.Authorization.Impersonation
{
    public class ImpersonationManager : MessagingPortalDomainServiceBase, IImpersonationManager
    {
