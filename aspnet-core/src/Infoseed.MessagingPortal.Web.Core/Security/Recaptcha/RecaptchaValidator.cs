...
namespace Infoseed.MessagingPortal.Web.Security.Recaptcha
{
    public class RecaptchaValidator : MessagingPortalServiceBase, IRecaptchaValidator, ITransientDependency
    {
