...
using Infoseed.MessagingPortal.Web.UiCustomization.Metronic;

namespace Infoseed.MessagingPortal.Web.UiCustomization
{
    public class UiThemeCustomizerFactory : IUiThemeCustomizerFactory
    {
        ...
        private IUiCustomizer GetUiCustomizerInternal(string theme)
        {
            ...
            if (theme.Equals(AppConsts.ThemeDefault, StringComparison.InvariantCultureIgnoreCase))
            {
