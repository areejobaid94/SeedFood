...
using Infoseed.MessagingPortal.Web.Chat.SignalR;
using Infoseed.MessagingPortal.Web.Configuration;
using Infoseed.MessagingPortal.Web.DashboardCustomization;

namespace Infoseed.MessagingPortal.Web
{
    [DependsOn(
    ...
    public class MessagingPortalWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MessagingPortalWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(MessagingPortalApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MessagingPortalWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(MessagingPortalWebCoreModule).Assembly);
        }
