...
namespace Infoseed.MessagingPortal.WhatsApp.Dto
{
    ...
    public class MessageTemplateModel
    {
        ...
        public double? message_send_ttl_seconds { get; set; }
        ...
        public string parameter_format { get; set; }
        ...
        [JsonProperty("mediaLinkCard")]
        public string[] mediaLinkCard { get; set; }
        ...
        [JsonProperty("variableHeaderCount")]
        public int variableHeaderCount { get; set; }


        [JsonProperty("variableURLButton1")]
        public bool variableURLButton1 { get; set; }

        [JsonProperty("variableURLButton2")]
        public bool variableURLButton2 { get; set; }
    ...
    public class WhatsAppExampleModel
    {
        ...
        [JsonProperty("mediaCard")]
        public string[] mediaCard { get; set; }
    ...
    public class WhatsAppApiErrorResponse
    {
