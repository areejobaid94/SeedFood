...
using Infoseed.MessagingPortal.Controls;
using Infoseed.MessagingPortal.Dto;
using Infoseed.MessagingPortal.Extensions;
using Infoseed.MessagingPortal.Localization;
using Infoseed.MessagingPortal.UI;
using Infoseed.MessagingPortal.UI.Assets;
using Infoseed.MessagingPortal.Views;
using DependencyResolver = Infoseed.MessagingPortal.Core.Dependency.DependencyResolver;
...
namespace Infoseed.MessagingPortal.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "MessagingPortal";
