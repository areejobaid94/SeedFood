...
using Infoseed.MessagingPortal.Web.Public.Startup;
using Infoseed.MessagingPortal.Web.Session;

namespace Infoseed.MessagingPortal.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : MessagingPortalViewComponent
    {
