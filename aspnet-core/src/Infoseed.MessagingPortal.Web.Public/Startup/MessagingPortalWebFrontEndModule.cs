...
namespace Infoseed.MessagingPortal.Web.Public.Startup
{
    [DependsOn(
        typeof(MessagingPortalWebCoreModule)
    )]
    public class MessagingPortalWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public MessagingPortalWebFrontEndModule(IWebHostEnvironment env, MessagingPortalEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MessagingPortalWebFrontEndModule).GetAssembly());
        }
    }
}
