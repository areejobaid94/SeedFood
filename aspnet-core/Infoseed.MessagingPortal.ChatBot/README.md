# Infoseed.MessagingPortal.ChatBot
...
- In a terminal, navigate to `Infoseed.MessagingPortal.ChatBot`

    ```bash
    # change into project folder
    cd Infoseed.MessagingPortal.ChatBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Infoseed.MessagingPortal.ChatBot` folder
  - Select `Infoseed.MessagingPortal.ChatBot.csproj` file
