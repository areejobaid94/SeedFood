...
namespace Infoseed.MessagingPortal.Integration
{
    ...
    public class MessagingPortalIntegrationModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public MessagingPortalIntegrationModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(MessagingPortalIntegrationModule).GetAssembly());
        }
