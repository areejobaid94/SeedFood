...
//    [ApiController]
//    public class GlameraController : MessagingPortalControllerBase
//    {
...
//        public GlameraController(IDocumentClient documentClient, IDBService dbService, ITargetReachAppService iTargetReachAppService)
//        {
...
//        //[Route("SendMessage")]
//        //[HttpPost]
//        //public async Task<string> SendMessageAsync(TargetReachModel item, string key)
//        //{
...
//        //        targetReachEntity.TemplateName = item.TemplateName;// TargetReachTemplateEnum.keyword_test.ToString();
