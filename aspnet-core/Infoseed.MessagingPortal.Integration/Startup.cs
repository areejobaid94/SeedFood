...
namespace Infoseed.MessagingPortal.Integration
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
         ...
         //  FcmNotificationSetting.webAddr = _appConfiguration.GetSection("FcmNotification").GetChildren().Where(x => x.Key == "webAddr").FirstOrDefault().Value;
            ...
            services.AddScoped<IUTrackOrderAppService, UTrackOrderAppService>();
            services.AddScoped<ITargetReachAppService, TargetReachAppService>();
           ...
           // services.AddAutoMapper(typeof(InfoSeedBotAPIAutoMapping.AutoMapping));
            ...
            return services.AddAbp<MessagingPortalIntegrationModule>(options =>
            {
