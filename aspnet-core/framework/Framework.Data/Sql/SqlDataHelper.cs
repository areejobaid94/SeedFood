...
namespace Framework.Data
{
    ...
    public static class SqlDataHelper
    {
        ...
        public static IList<T> ExecuteReader<T>(string spName, DbParameter[] param, Converter<IDataReader, T> converter, string connectionString)
        {
            ...
            try
            {
                dataConnection = new SqlConnection(connectionString); //DataProviderFactory.CreateConnection();
        ...
        public static T ExecuteItem<T>(string spName, DbParameter[] param, Converter<IDataReader, T> converter, string connectionString ) where T : new()
        {
            T result = default(T);
            IDataReader reader = null;
            DbCommand dbCommand = null;
        ...
        public static object ExecuteScalar(string spName, DbParameter[] param, string connectionString)
        {
            object results = null;
            DbCommand dbCommand = null;
            DbConnection dataConnection;
        ...
        public static int? ExecuteNoneQuery(string spName, DbParameter[] param, string connectionString)
        {
            int? result = null;
            DbCommand dbCommand = null;
            DbConnection dataConnection;
