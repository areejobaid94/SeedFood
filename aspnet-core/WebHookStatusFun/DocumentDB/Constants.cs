namespace WebHookStatusFun
{
    public static class Constants
    {
        ...
        {
            public static string SP_ContactsAddBulk = "[dbo].[ContactsAddBulk]";
            public static string SP_AddFiledContactBulk = "[dbo].[AddFiledContactBulk]";
        ...
        {
            public static string SP_SendCampaignListGetFromDB = "[dbo].[SendCampaignListGetFromDB]";
            ...
            public static string SP_WhatsAppScheduledCampaignUpdate = "[dbo].[WhatsAppScheduledCampaignUpdate]";
            ...
            public static string SP_ScheduledCampaignGetFromDB = "[dbo].[ScheduledCampaignGetFromDB]";
            public static string SP_SendCampaignGetFromDB = "[dbo].[SendCampaignGetFromDB]";
            public static string SP_CampaignUpdateStatus = "[dbo].[CampaignUpdateStatus]";
            public static string SP_ScheduledCampaignUpdateStatus = "[dbo].[ScheduledCampaignUpdateStatus]";
            public static string SP_DailyLimitByTenantId = "[dbo].[DailyLimitByTenantId]";
        }
        public static class Group
        {
            public static string UpdateCreatGroupNumber = "[dbo].[UpdateCreatGroupNumber]";
            public static string GroupsGetQueDB = "[dbo].[GroupsGetQueDB]";
            public static string GroupGetQueDB = "[dbo].[GroupGetQueDB]";
            public static string AddMembersOnGroupFromJop = "[dbo].[AddMembersOnGroupFromJop]";
            public static string GroupGetListQueDB = "[dbo].[GroupGetListQueDB]";
        }
        ...
        //public static string BotApi = "https://infoseedengineapi-stg.azurewebsites.net/";
    ...
    public static class Constant
    {
        ...
        /// stg
        /// </summary>
        //public static string connectionStringMongoDB = "mongodb+srv://infoseed:P%40ssw0rd@campagindbstg.global.mongocluster.cosmos.azure.com/?tls=true&authMechanism=SCRAM-SHA-256&retrywrites=false&maxIdleTimeMS=120000";
        ...
        /// prod
        /// </summary>
        public static string connectionStringMongoDB = "mongodb+srv://infoseed:P%40ssw0rd@campagindb.global.mongocluster.cosmos.azure.com/?tls=true&authMechanism=SCRAM-SHA-256&retrywrites=false&maxIdleTimeMS=120000";
