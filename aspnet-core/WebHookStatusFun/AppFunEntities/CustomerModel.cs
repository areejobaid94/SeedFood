...
namespace WebHookStatusFun
{
    public class CustomerModel
    {
        ...
        public List<CustomerChat> listCustomerChat { get; set; } = new List<CustomerChat>();
        ...
        public DateTime? LastMessageData { get; set; } = DateTime.UtcNow;
        public DateTime? LastConversationStartDateTime { get; set; } = DateTime.UtcNow;
        ...
        public int NumberNote { get; set; } = 0;
        ...
        public DateTime? requestedLiveChatTime { get; set; } = DateTime.UtcNow;
        ...
        public DateTime? OpenTimeTicket { get; set; } = DateTime.UtcNow;
        public DateTime? CloseTimeTicket { get; set; } = DateTime.UtcNow;
        ...
        public CustomerStepModel CustomerStepModel { get; set; } = new CustomerStepModel();
        ...
        public FacebookUserInfoModel facebookUserInfoModel { get; set; }
        public InstagramUserInfoModel instagramUserInfoModel { get; set; }
    ...
    public class CustomerStepModel
    {
        ...
        public AttachmentBotModel[] attachmentModels { get; set; } = new AttachmentBotModel[0];
    ...
    public class InstagramUserInfoModel
    {
        ...
        public bool is_user_follow_business { get; set; }
        public bool is_business_follow_user { get; set; }
        public string id { get; set; }
