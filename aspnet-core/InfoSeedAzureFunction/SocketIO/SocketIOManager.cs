...
namespace Infoseed.InfoSeedAzureFunction
{
    ...
    public static class SocketIOManager
    {
        ...
        public static void Init()
        {
           ...
           // var url = new Uri("https://infoseedsocketioserverstg.azurewebsites.net/");
         ...
         //   var Token = "313cb6e6-caad-4457-a0e4-669415d93250";
         //   var URL = "https://infoseedsocketioserverstg.azurewebsites.net/";


            client = new SocketIO(Constant.SocketIOURL, new SocketIOOptions
            {
                Query = new Dictionary<string, string>
                {
                     {"token",Constant.SocketIOToken}
                },
            });

            client.OnConnected += Socket_OnConnected;
            client.OnReconnected += Socket_OnReconnecting;
        ...
        public static void SendOrder(object model, int tenantId)
        {
        ...
        private static object TocamelCase(object model)
        {
            ...
            {
                string modelString2 = JsonSerializer.Serialize<object>(model);
                object newmodel2 = JsonSerializer.Deserialize<object>(modelString2);
                return newmodel2;
