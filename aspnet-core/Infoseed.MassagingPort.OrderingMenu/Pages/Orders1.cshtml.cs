...
{
    public class Orders1Model : PageModel
    {
        ...
        public  void OnGet()
        {
            ...
            if (this.UrlKey != "")
            {
                ...
                var link = _iMenusAppService.MenuContactKeyGetNew(menuContcatKeyModel).Value;
        ...
        private List<OrderingCartItemModel> PrepareItems(List<OrderingOrdersItemModel> items, int tenantId, int contactid)
        {
            ...
            foreach (var item in items)
            {
                ...
                if (itemDtos != null)
                {
                    ...
                    // objOrderingCartItemModel.IsLoyal = objOrderingCartItemModel.IsLoyal;
