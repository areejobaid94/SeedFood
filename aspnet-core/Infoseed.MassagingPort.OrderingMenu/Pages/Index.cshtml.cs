...
using Infoseed.MassagingPort.OrderingMenu.Pages.Market;
using Infoseed.MassagingPort.OrderingMenu.Pages.Model;
using Infoseed.MassagingPort.OrderingMenu.Pages.Shared;
using Infoseed.MassagingPort.OrderingMenu.Services;
using Infoseed.MassagingPort.OrderingMenu.ViewComponents;
...
using Infoseed.MessagingPortal.ItemSpecifications;
...
using Infoseed.MessagingPortal.SpecificationChoices;
using SpecificationChoice = Infoseed.MessagingPortal.Items.SpecificationChoice;
using Infoseed.MessagingPortal.Specifications;
using GraphQL;
using System.Web;
    ...
    public bool IsLoyalty { get; set; }
        ...
        public async void OnGet()
        {
            ...
            if (this.UrlKey!="")
            {
                ...
                var link =  _iMenusAppService.MenuContactKeyGet(menuContcatKeyModel);
                ...
                if (link!=null)
                {
                    ...
                    if (this.TenantID != 0)
                    {
                        ...
                        if (this.TenantID == 14 || this.TenantID == 46 || this.TenantID == 15 || this.TenantID == 29 || this.TenantID == 24 ||
                            //this.TenantID == 20 ||
                           // this.TenantID == 19 ||
                            this.TenantID == 35 || this.TenantID == 9)
                                ...
                                foreach (var item in result)
                                {
                                    if (item.listItemInCategories != null)
                                    {
                                        OrderingMenuCategoryModel objOrderingMenuCategoryModel = new()
                                        {
                                            ...
                                            lstOrderingMenuItemModel = PrepareItemList(item.listItemInCategories, this.AreaId).OrderBy(x => (x.Priority)).ToList(),
        ...
        public async Task<IActionResult> OnGetSubCategoriesandItems(int tenantID, bool isLoyaltyApplay, string subCateoryname, string currencyCode, int areaId, int PageNumber, string loyaltyModelJson = "", long subCategoryid = 0, string search = "", int IsSort = 0)
        {
            ...
            if (tenantID != 0)
            {
                ...
                {
                    advResult = _IItemsAppService.GetLoyaltyItems(tenantID, areaId, 1, PageNumber, orderingMenuItemPagenationModel.PageSize, out totalCount);
                ...
                {
                    advResult = _IItemsAppService.GetItemsBySubGategory(tenantID, areaId, subCategoryid, 1, PageNumber, orderingMenuItemPagenationModel.PageSize, out totalCount);
                }
                ...
                if (orderingMenuItemPagenationModel.lstOrderingMenuItemModel != null && orderingMenuItemPagenationModel.lstOrderingMenuItemModel.Count > 0)
                {
                    ...
                    if (subCategoryid == 0 && isLoyaltyApplay)
                    {
                        return Partial("Pages/Shared/_LoyaltyItems.cshtml", orderingMenuItemPagenationModel);

                    }
                    else
                    {

                        return Partial("Pages/Shared/_SubCategoryItems.cshtml", orderingMenuItemPagenationModel);
...

        {
            ...
            if (itemDtos != null)
            {
              ...
              //  orderingMenuProductDetailsModel.IsInService = itemDtos.IsInService;
                ...
                if (itemDtos.ItemSpecifications != null)
                {
                    ...
                    orderingMenuProductDetailsModel.lstOrderingMenuItemSpecificationsModel = PrepareSpesifcationList(isLoyaltyApplay, itemDtos.ItemSpecifications, loyaltyModel);
                ...
                if (itemDtos.additionsCategorysListModels != null)
                {
                    ...
                    orderingMenuProductDetailsModel.lstOrderingMenuItemAdditionsCategorysModel = PrepareAdditionsList(isLoyaltyApplay, itemDtos.additionsCategorysListModels, loyaltyModel);
                ...
                if (isLoyaltyApplay)
                {
                    orderingMenuProductDetailsModel.LoyaltycreditPoints = CalculatPointcredit(tenantId, orderingMenuProductDetailsModel.ViewPrice,loyaltyModelJson);
                }
            ...
            return Partial("Pages/Market/ProductDetails.cshtml", orderingMenuProductDetailsModel);
        }
...

        {
            ...
            return Partial("Pages/Shared/_HeaderMarket.cshtml", orderingMenuTenantModel);
        ...
        public async Task<IActionResult> OnPostCartItemAsync( bool isApplayLoyalty,string ItemsJson,string loyaltyModelJson)
        {
            ...
            var result = await _viewRenderService.RenderToStringAsync("_CartItem", lstOrderingCartItemModel);
            return new JsonResult(result); ;
        ...
        public async Task<IActionResult> OnPostSubListAsync(string ItemsJson)
        {
            ...
            var result = await _viewRenderService.RenderToStringAsync("_SubCategorys", listOrderingMenuSubCategoryModel);
            return new JsonResult(result); ;
        ...
        public async Task<IActionResult> OnPostSubmitOrderAsync(string ItemsJson, bool isLoyaltyApplay, string orderNote)
        {
            ...
            if (orderId > 0)
            {
                await SendToBotAsync(orderModel.ContactId, orderModel.TenantId, orderId, orderModel.Total);
            }
            ...
            if (this.TenantID != 0)
            {
                ...
                if (tenantInfo != null)
                {
                  ...
                  //  var DateEnd = Convert.ToDateTime(tenantInfo.EndDate.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture));
                    ...
                    //if (tenantInfo.OrderType.Contains(this.OrderType.ToString()) && tenantInfo.IsApplyLoyalty && DateStart <= DateNow && DateEnd >= DateNow)
                    //{
        ...
        private List<OrderingMenuSubCategoryModel> SubCategoryLoyalty()
        {
            ...
            getSubCategorysModel.SubCategoryName = "النقاط";
            getSubCategorysModel.SubCategoryNameEnglish = "Loyalty";
        ...
        private List<OrderingMenuCategoryModel> CategoryLoyalty()
        {
            ...
            objOrderingMenuCategoryModel.CategoryName = "النقاط";
            objOrderingMenuCategoryModel.CategoryNameEnglish = "Loyalty";
        ...
        private List<OrderingMenuItemModel> PrepareItemList(List<ItemDto> itemDtos ,int areaId)
        {
            ...
            foreach (var item in itemDtos)
            {
                ...
                if (item.InServiceIds!=null && item.InServiceIds !="" && item.InServiceIds !=",")
                {
                    ...
                    if (item.InServiceIds.Contains(areaId.ToString()) || areaId==0)
                    {
                        objOrderingMenuItemModels.IsInService=true;
                    }
                    else
                    {
                        objOrderingMenuItemModels.IsInService =false;
                ...
                objOrderingMenuItemModels.AreaId = areaId.ToString();
                objOrderingMenuItemModels.InServiceIds=item.InServiceIds;
        ...
        private List<OrderingMenuItemSpecificationsModel> PrepareSpesifcationList(bool isLoyaltyApplay, List<ItemSpecification> _OrderingMenuItemSpecificationsModel, LoyaltyModel loyaltyModel)
        {
            ...
            foreach (var item in _OrderingMenuItemSpecificationsModel)
            {
                ...
                {
                    objOrderingMenuItemSpecificationsModel.lstOrderingMenuSpecificationChoiceModel = PrepareSpesifcationChoiceList(isLoyaltyApplay, item.SpecificationChoices, loyaltyModel);
        ...
        private List<OrderingMenuItemAdditionsCategorysModel> PrepareAdditionsList(bool isLoyaltyApplay, List<AdditionsCategorysListModel> _OrderingMenuItemAdditionsCategorysModel, LoyaltyModel loyaltyModel)
        {
            ...
            if (_OrderingMenuItemAdditionsCategorysModel != null)
            {
                foreach (var item in _OrderingMenuItemAdditionsCategorysModel)
                {
                    ...
                    {
                        objOrderingMenuItemAdditionsCategorysModel.OrderingMenuItemAdditionModel = PrepareAdditionList(isLoyaltyApplay, item.ItemAdditionDto, loyaltyModel);
        ...
        private List<OrderingMenuItemAdditionModel> PrepareAdditionList(bool isLoyaltyApplay, List<ItemAdditionDto> _OrderingMenuItemAdditionModel, LoyaltyModel loyaltyModel)
        {
        ...
        private List<OrderingMenuSpecificationChoiceModel> PrepareSpesifcationChoiceList(bool isLoyaltyApplay, List<SpecificationChoice> _OrderingMenuSpecificationChoiceModel, LoyaltyModel loyaltyModel)
        {
        ...
        private List<OrderDetailsModel> PrepareOrder(List<OrderingCartItemModel> orderingCartItemModels, int TenantID, bool isLoyaltyApplay, out decimal totalPrice, out decimal totalPoints, out decimal totalCreditPoints)
        {
            ...
            foreach (var item in orderingCartItemModels)
            {
                ...
                if (item.ItemNote != "" && item.ItemNote != null)
                {
        ...
        private async Task SendToBotAsync(int CustomerId, int tenantId,long orderId, decimal OrderTotal)
        {
            ...
            try
            {
                ...
                if (tenant != null && !string.IsNullOrEmpty(tenant.AccessToken))
                {
                    ...
                    var result = await sendToWhatsApp(tenant, user, orderId, OrderTotal);
                }
        ...
        private async Task<bool> sendToWhatsApp(TenantModel Tenant, CustomerModel user, long orderId, decimal OrderTotal)
        {
        ...
        private void CalculatePrices(OrderingCartItemModel item, bool isLoyaltyApplay, LoyaltyModel loyaltyModel)
        {
            ...
            if (itemDtos.IsLoyal)
            {
                ...
                if (loyaltyModel.IsLoyalityPoint)
                    TotalCreditPoints += (loyaltyModel.ItemsPoints * total) / (loyaltyModel.ItemsCurrencyValue);
            }
            item.Total = total;
            if (isLoyaltyApplay)
            {
