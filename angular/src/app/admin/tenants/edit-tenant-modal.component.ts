...
import { BotTemplatesModel, CommonLookupServiceProxy, GeneralServiceProxy, SubscribableEditionComboboxItemDto, TenantEditDto, TenantServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class EditTenantModalComponent extends AppComponentBase {
    ...
    botTemplates : BotTemplatesModel[] = []
    ...
    show(tenantId: number): void {
        this.active = true;
        this.botTemplates = [];
        this._generalServiceProxy.getBotTemplates().subscribe(result => {
            this.botTemplates = result;
