...
import {
    ...
    TenantServiceProxy, SubscribableEditionComboboxItemDto, TenantTypeEunm, GeneralServiceProxy, BotTemplatesModel
...
export class CreateTenantModalComponent extends AppComponentBase {
    ...
    show() {
        this.active = true;
        this._generalServiceProxy.getBotTemplates().subscribe(res => {
            this.botTemplates = res;
            this.modal.show();
        });
        this.init();
    ...
    save(): void {
        ...
        // this.tenant.tenantType=this.tenantTypeEunms;
