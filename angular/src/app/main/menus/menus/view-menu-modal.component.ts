...
export class ViewMenuModalComponent extends AppComponentBase {
    ...
    show(item: MenuDto): void {
        ...
        this._menusServiceProxy
            .getItemAdditionDetailsListForView(item.restaurantsType)
            .subscribe((res) => {
                this.item = res;
    ...
    onchangeBranch(event: any): void {
        this._menusServiceProxy
            .getItemAdditionDetailsListForView(event.target.value)
            .subscribe((res) => {
                this.item = res;
            });
    }
    ...
    save(): void {
        this._menusServiceProxy
            .updateItemAdditionDetailsListForView(this.item)
            .subscribe((res) => {
                this.active = false;
                this.modal.hide();
            });
