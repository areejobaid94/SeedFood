...
export class OrderSignalRService extends AppComponentBase {
...
//         abp.signalr.connect();
//         abp.signalr.startConnection(AppConsts.remoteServiceBaseUrl +'/order', connection => {
...
//                                 .withUrl( AppConsts.remoteServiceBaseUrl +'/order')
...
//         this.hubConnection
//           .start()
//           .then(() => console.log('Connection started with ORDER SIGNAL R'))
...
//           .then(() => console.log("Connection stoped with ORDER SIGNAL R")
//           )
//       }


//     public addBroadcastBotOrderListener = () => {


//         this.hubConnection.on('brodCastBotOrder', (data) => {
...
//       public addBroadcastAgentOrderListener = () => {

//         this.hubConnection.on('brodCastAgentOrder', (data) => {
