...
GetAllLocations(TenantId:number):Observable<LocationListModel[]> {
    return this.http.get<LocationListModel[]>(AppConsts.remoteServiceBaseUrl + '/api/Locations/GetAllLocationsList?TenantId='+TenantId);
}
