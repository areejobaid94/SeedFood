...
//import { MessageTemplateComponent } from './src/app/main/message-template/message-template.component';

import { Sidebarthem12Component } from './shared/layout/nav/sidebarthem12/sidebarthem12.component';
import { CoreConfigService, CORE_CUSTOM_CONFIG } from '../@core/services/config.service';
//import { SocketIoModule, SocketIoConfig } from 'ngx-socket-io';
//import { io } from 'socket.io-client';
import { SocketioService } from './shared/socketio/socketioservice';
import { TeamInboxSignalRService } from './main/teamInbox/teaminbox-signalR.service';
import { SocketIoModule, SocketIoConfig } from 'ngx-socket-io';
import { environment } from 'environments/environment';
import { ProgressBarComponent } from './progress-bar/progress-bar.component';
import { AngularFireModule } from '@angular/fire/compat';
import { AngularFireMessagingModule } from '@angular/fire/compat/messaging';
import { FacebookServiceProxy, UserTokenModel, WhatsAppDialogServiceProxy } from '@shared/service-proxies/service-proxies';
import {CookieService} from 'ngx-cookie-service';
import { ThemeServicesService } from '@shared/shared-services/theme-services.service';
import { CustomeCoreModule } from '@core/core.module';
...
import { FacebookAuthDialogComponent } from './shared/layout/themes/shared/facebook-auth-dialog/facebook-auth-dialog.component';


const config: SocketIoConfig = { url: environment.socketIoUrl, options: {
     query: {
    
       //  token: '313cb6e6-caad-4457-a0e4-669415d93250', // stg
         token: environment.socketIoToken,//prod
       },
...
// const config2 = io('https://localhost:3009', {
//     query: {
...
@NgModule({
    declarations: [
        ...
        AutofocusDirective,
        Sidebarthem12Component,
        ProgressBarComponent,
        OfflineNotificationComponent,
       // FacebookConnectComponent,
        FacebookAuthDialogComponent
    ...
    providers: [
        ...
        SocketioService,
        WhatsAppDialogServiceProxy,
        TeamInboxSignalRService,
        CookieService,
        ThemeServicesService,
