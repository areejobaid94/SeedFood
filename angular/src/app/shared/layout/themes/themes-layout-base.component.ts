...
export class ThemesLayoutBaseComponent extends AppComponentBase {
    ...
    private get isTeamInboxPage(): boolean {
        return window.location.pathname.includes("teamInbox/teamInbox");
    }

    public get fullScreenLayout(): boolean {
        return !this.isAdmin && this.isTeamInboxPage;
    }
