...
import en from '@angular/common/locales/fr';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'MessagingPortal',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for MessagingPortal'
    });
}
...
function getDefaultThemeForInstallPage(): UiCustomizationSettingsDto {
    ...
    theme.baseSettings.theme = 'theme12';
...
function registerLocales(resolve: (value?: boolean | Promise<boolean>) => void, reject: any, spinnerService: NgxSpinnerService) {
    if (shouldLoadLocale()) {
        ...
        import(`../node_modules/@angular/common/locales/global/${angularLocale}.js`)
            .then(module => {
...
@NgModule({
    imports: [
        ...
        MessagingPortalCommonModule.forRoot(),
        ServiceProxyModule,
        HttpClientModule,
        RootRoutingModule,
        NgxSpinnerModule
