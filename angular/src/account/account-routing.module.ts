        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'cancellation-policy', component: CancellationPolicyComponent, canActivate: [AccountRouteGuard] },
                    { path: 'Privcy-Policy', component: PrivcyPolicyComponent, canActivate: [AccountRouteGuard] },
