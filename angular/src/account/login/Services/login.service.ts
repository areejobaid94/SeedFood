...
export class LoginService {
    ...
    authenticate(finallyCallback?: () => void, redirectUrl?: string, captchaResponse?: string): void {
        ...
        this._localStorageService.getItem(LoginService.twoFactorRememberClientTokenName, function (err, value) {
            ...
            localStorage.setItem('userNameOrEmailAddress',(self.authenticateModel['userNameOrEmailAddress']));
            localStorage.setItem('password',self.authenticateModel['password']);
            localStorage.setItem('rememberClient',JSON.stringify(self.authenticateModel['rememberClient']));
